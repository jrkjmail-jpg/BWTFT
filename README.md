...
3. Бот предлагает 5 тематик сказки с кнопками выбора, «Редактировать тему» и «Предложить ещё».
4. Пользователь выбирает вариант или надиктовывает/вводит свои пожелания к теме.
...
9. Для каждой страницы можно запросить три варианта одного иллюстрируемого момента,
   выбрать сцену и свободно отредактировать финальный промпт текстом или голосом.
